...
def get_function_schema(f: Callable[..., Any], *, name: Optional[str] = None) -> Dict[str, Any]:
    ...
    function = ToolFunction(function=Function(name=fname, description=description, parameters=parameters))
